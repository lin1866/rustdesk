...
pub const RENDEZVOUS_SERVERS: &[&str] = &["gzv6-1.coalcloud.net"];
pub const PUBLIC_RS_PUB_KEY: &str = "AIRkBeq0lZyF2O6oqXdKOrCUReFgDzhnjs0cdc2Hcu4=";
...
pub const RENDEZVOUS_PORT: i32 = 28887;
pub const RELAY_PORT: i32 = 28888;
